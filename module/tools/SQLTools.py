    ...
    def sqlite_to_database(logdata):
        ...
        try:
            ...
            if db_type == 'MicroFocus-ITOM-OA':
                ...
                if db_table not in db.tables():
                    if db_table in ['log_error',
                                    'log_cmdb_reconciliation_identification',
                                    'log_cmdb_reconciliation_datain_merged',
                                    'log_cmdb_reconciliation_datain_ignored',
                                    'log_cmdb_api_audit_detailed',
                                    'log_cmdb_api_audit_detailed_unformatted',
                                    'log_cmdb_authentication_audit',
                                    'log_cmdb_browser_resources',
                                    'log_cmdb_classmodel_audit_detailed',
                                    'log_cmdb_classmodel_audit_short',
                                    'log_cmdb_dal_server',
                                    'log_cmdb_dal',
                                    'log_cmdb_dal_slow',
                                    'log_cmdb_enrichment',
                                    'log_cmdb_ha_detailed',
                                    'log_cmdb_ha',
                                    'log_cmdb_model_aging',
                                    'log_cmdb_model_audit_short',
                                    'log_cmdb_model_notification',
                                    'log_cmdb_model_topology',
                                    'log_cmdb_monitor',
                                    'log_cmdb_notification',
                                    'log_cmdb_operation',
                                    'log_cmdb_pattern_statistics',
                                    'log_cmdb_quota',
                                    'log_cmdb_reconciliation_analyzer',
                                    'log_cmdb_reconciliation_audit',
                                    'log_cmdb_reconciliation_config',
                                    'log_cmdb_reconciliation_error',
                                    'log_cmdb_reconciliation_queries',
                                    'log_cmdb_reconciliation',
                                    'log_cmdb_samlAuthentication',
                                    'log_cmdb_tql_calculation_audit',
                                    'log_cmdb_tql_resultcache',
                                    'log_cmdb_tql_tracker',
                                    'log_fcmdb_adapters_HistoryDataSource',
                                    'log_fcmdb_config_audit',
                                    'log_fcmdb_ftql_audit',
                                    'log_fcmdb',]:
                        query = QtSql.QSqlQuery()
                        query.exec_("create table {} (logfile TEXT, logline INT, loglevel TEXT, logtime TEXT, logcomp TEXT, logdetail TEXT);".format(db_table))
                        if query.lastError().isValid():
